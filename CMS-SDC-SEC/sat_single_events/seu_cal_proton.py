    ...
    for solar in scenario:
        ...
        if Bendel == 1: 
            if para_switch == 1:
                ...
                para_name = (para_name[para_name.index(Bendel_para_name)])
            elif para_switch == 2:
                A = float(sys.argv[6])
                para_name = 'user-defined material'
            Cross = Cal_Bendel1(E, A)
...
dic = {}
if Bendel == 1:
    dic['material name'] = para_name
    dic['Bendel single para A value'] = A
else:
    dic['material name'] = para_name
    dic['Bendel double para A value'] = A
    dic['Bendel double para B value'] = B
...
dic['sloar max 3mm depth'] = total_SEU[4]
