...
def get_new_list(file_time,S1_value,S2_vaule):
    l1_data,l2_data = [], []
    for h in range(len(file_time)):
        l1_data.append([file_time[h], S1_value[h]])
        l2_data.append([file_time[h], S1_value[h]])
...
def main(file_path, params_system, PRN, P1_channel, P2_channel, stat_time, end_time):
    ...
    l1_data, l2_data = get_new_list(file_time,S1_value,S2_vaule)
    all_dict = {'L1_S4':l1_data,'L2_S4':l2_data}
    print(all_dict)
...
if __name__ == '__main__':
    ...
    # PRN = '01'      #卫星编号，01是G卫星，23是C卫星，02是E卫星，11是R卫星
