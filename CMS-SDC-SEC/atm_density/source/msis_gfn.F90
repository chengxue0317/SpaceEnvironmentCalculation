...
contains
  ...
  subroutine globe(doy,utsec,lat,lon,sfluxavg,sflux,ap,bf)
    ...
    ! Terms needed for legacy geomagnetic activity dependence c=389
    ...
    ! Terms needed for legacy UT dependence c=443
    c = cut
  ...
  real(kind=rp) function geomag(p0,bf,plg)
    ...
    ! Copy parameters
    p = p0
    ! nmag=54: Number of terms in NRLMSISE-00 legacy geomagnetic parameterization
    ! cmag: Starting index of daily geomagnetic terms
