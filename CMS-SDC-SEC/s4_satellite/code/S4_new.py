...
def main(file_path, endTime,forecastPeriod,interval,p1Channel,p2Channel,prn,statTime,system,time,paramsSystem):
    ...
    strength_value_S1, strength_value_S2, file_time, all_DB_S1, all_DB_S2 = satellite.main(file_path, value[5], value[2], value[6], value[7],value[8],value[9])
    ...
    local_changes_value = local_changes(dimian_zuobiao)
    all_dict = {
        ...
        'L1频段对卫星导航信号影响衰减量级(DB)': all_DB_S1,
        'L2频段对卫星导航信号影响衰减量级(DB)': all_DB_S2,
