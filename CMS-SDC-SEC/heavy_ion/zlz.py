...
def Cal_ion_flux_in_different_scenario(incl,geo_height,ion_index,scenario):
	...
	######################
	flux_i_low_height_high = flux_high
	flux_i_low_height_low  = flux_low 
	flux_i_low_height_target = flux_i_low
	######################
	...
	######################
	flux_i_high_height_high = flux_high
	flux_i_high_height_low  = flux_low 
	flux_i_high_height_target = flux_i_high
	######################
