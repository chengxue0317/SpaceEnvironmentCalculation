Program ap8ae8
    ...
    case(1, 2)
        nene = 7
        energy(1, 1:7) = (/0.05, 0.1, 0.15, 0.35, 0.65, 1.2, 2.0/)
        energy(2, 1:7) = (/0.1, 0.15, 0.35, 0.65, 1.2, 2.0, 5.7/)
    case(3, 4)
        nene = 12
        energy(1, 1:12) = (/0.1, 0.5, 1., 3., 5.,  10., 20., 40.,  80., 120., 160., 200./)
        energy(2, 1:12) = (/0.5,   1., 3., 5., 10., 20., 40., 80., 120., 160., 200., 300./)
    end select
