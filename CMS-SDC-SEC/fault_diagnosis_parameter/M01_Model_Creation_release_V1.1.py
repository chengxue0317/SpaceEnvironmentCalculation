"""
20230613 修改传参规则，目前log和model文件的上级目录由后端传递；
"""
# import json
import sys
...
if __name__ == '__main__':
    ...
    # "E:\Code\Python\机器学习\专家系统实战\故障诊断多参数_202302223"
    sub_path = sys.argv[6]
    # log

    # 创建log文件夹
    log_path = os.path.join(sub_path,"log")
    ...
    # 先创建个model路径
    model_total_path = os.path.join(sub_path, "model")
    file_exists(model_total_path)

    # 在model路径下创建子文件夹路径
    model_path = os.path.join(model_total_path,str(input_shape)+"特征量模型")
